...
CREATE TABLE beneficiario (
  ...
  KEY idx_beneficiario_ciudad (id_ciudad),
  KEY idx_beneficiario_tipo_poblacion (id_tipo_poblacion),
  CONSTRAINT fk_beneficiario_ciudad FOREIGN KEY (id_ciudad) REFERENCES ciudad (id_ciudad),
...
CREATE TABLE entrega_ayuda (
  ...
  id_ciudad_entrega INT DEFAULT NULL,
  ...
  KEY idx_entrega_ciudad (id_ciudad_entrega),
  ...
  CONSTRAINT fk_entrega_ciudad FOREIGN KEY (id_ciudad_entrega) REFERENCES ciudad (id_ciudad),
